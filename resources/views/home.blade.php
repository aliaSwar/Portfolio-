...
<x-layouts.app>
    <!-- home section start -->
    <section class="home" id="home" style="background-color:rgb(14, 13, 13)">
        <div class="max-width">
            <div class="home-content">
                <div class="text-1">Hello, my name is</div>
                <div class="text-2">Alia Swar</div>
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Alia Swar</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Syria,damascus</div>
                            </div>
                        </div>
                        <div class="row">
